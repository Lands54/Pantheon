"""Event catalog with semantic descriptions."""
...
_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "outbox_status_event": {
        "domain": "iris",
        "title": "发件箱状态事件",
        "description": "Iris 发件箱状态变更语义事件（pending/delivered/handled/failed）。",
        "llm_note": "经 Angelia 出队后转化为 outbox.sent.* intent。",
    },
    "inbox_read_event": {
        "domain": "iris",
        "title": "收件箱已读事件",
        "description": "Iris 收件箱已读/处理完成语义事件。",
        "llm_note": "经 Angelia 出队后转化为 inbox.read_ack intent。",
    },
    # Hermes

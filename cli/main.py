...
def main():
    ...
    config_sub.add_parser("audit", help="Audit config registry usage/deprecations")
    ...
    p_mn_art_list = mn_sub.add_parser("artifact-list", help="List Mnemosyne artifact refs")
    p_mn_art_list.add_argument("--scope", choices=["global", "project", "agent"], default="project")
    p_mn_art_list.add_argument("--actor", default="human")
    p_mn_art_list.add_argument("--owner", default="")
    p_mn_art_list.add_argument("--limit", type=int, default=50)
    p_mn_art_head = mn_sub.add_parser("artifact-head", help="Show one artifact ref metadata")
    p_mn_art_head.add_argument("artifact_id")
    p_mn_art_head.add_argument("--actor", default="human")
    p_mn_art_put_text = mn_sub.add_parser("artifact-put-text", help="Create artifact from inline text")
    p_mn_art_put_text.add_argument("--scope", choices=["global", "project", "agent"], default="agent")
    p_mn_art_put_text.add_argument("--actor", default="human")
    p_mn_art_put_text.add_argument("--owner", default="")
    p_mn_art_put_text.add_argument("--mime", default="text/plain")
    p_mn_art_put_text.add_argument("--tags", default="")
    p_mn_art_put_text.add_argument("--content", required=True)
    p_mn_art_put_file = mn_sub.add_parser("artifact-put-file", help="Create artifact from local file")
    p_mn_art_put_file.add_argument("--scope", choices=["global", "project", "agent"], default="agent")
    p_mn_art_put_file.add_argument("--actor", default="human")
    p_mn_art_put_file.add_argument("--owner", default="")
    p_mn_art_put_file.add_argument("--mime", default="")
    p_mn_art_put_file.add_argument("--tags", default="")
    p_mn_art_put_file.add_argument("--file", required=True)
    ...
    p_ctx_pulse = ctx_sub.add_parser("pulse", help="Pulse ledger operations")
    p_ctx_pulse_sub = p_ctx_pulse.add_subparsers(dest="action")
    p_ctx_pulse_list = p_ctx_pulse_sub.add_parser("list", help="List pulse frames")
    p_ctx_pulse_list.add_argument("agent")
    p_ctx_pulse_list.add_argument("--from-seq", type=int, default=0)
    p_ctx_pulse_list.add_argument("--limit", type=int, default=200)
    p_ctx_pulse_inspect = p_ctx_pulse_sub.add_parser("inspect", help="Inspect one pulse by id")
    p_ctx_pulse_inspect.add_argument("agent")
    p_ctx_pulse_inspect.add_argument("pulse_id")
    p_ctx_pulse_inspect.add_argument("--from-seq", type=int, default=0)
    p_ctx_pulse_inspect.add_argument("--limit", type=int, default=1000)
    p_ctx_pulse_validate = p_ctx_pulse_sub.add_parser("validate", help="Validate pulse integrity")
    p_ctx_pulse_validate.add_argument("agent")
    p_ctx_pulse_validate.add_argument("--from-seq", type=int, default=0)
    p_ctx_pulse_validate.add_argument("--limit", type=int, default=1000)

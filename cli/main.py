...
def main():
    ...
    p_proto_register.add_argument("--version", default="1.0.0")
    ...
    p_proto_register.add_argument("--function-id", default="", help="Routing function id")
    ...
    p_proto_call.add_argument("--version", default="1.0.0")
    ...
    p_contract_commit.add_argument("--name", required=True)
    ...
    p_contract_resolve.add_argument("--name", required=True)
    p_contract_resolve.add_argument("--version", required=True)
    proto_sub.add_parser("contract-list", help="List contracts")
